use image::{DynamicImage, ImageBuffer, Rgba, imageops::FilterType, GenericImageView};
use std::path::Path;
use anyhow::Result;
...
fn resize_with_aspect_ratio(img: DynamicImage, target_width: u32, target_height: u32) -> DynamicImage {
